...
import 'package:products_crud_flutter/core/viewmodels/CRUDModel.dart';
...
class _ModifyProductState extends State<ModifyProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Center(
          child: Text('Modificar detalles del producto'),
        ),
      ),
      body: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              RaisedButton(
                ...
                child: Text('Modificar Producto', style: TextStyle(color: Colors.white)),
                color: Colors.blue,
              )
